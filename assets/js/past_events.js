...
window.addEventListener("load", function () {
  const recorrerCardsYRenderizarTarjetasPastEvents = () => {
    const contenedorCard = document.getElementById("cardsPastEvents");
  ...
  recorrerCardsYRenderizarTarjetasPastEvents();
});
